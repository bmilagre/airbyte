...
import pytest
from source_google_mb.source import GoogleMbStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(GoogleMbStream, "path", "v0/example_endpoint")
    mocker.patch.object(GoogleMbStream, "primary_key", "test_primary_key")
    mocker.patch.object(GoogleMbStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = GoogleMbStream()
